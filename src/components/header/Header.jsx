          ...
          <nav className="nav container">
              ...
              <div className={Toggle ? "nav__menu show-menu" : "nav__menu"}>
                  <ul className="nav__list grid">
                      ...
                      <li className="nav__item">
                          <a href="#Sobre" onClick={() => setActiveNav("#Sobre")} className=
                            {activeNav === "#Sobre" ? "nav__link active__link" : "nav__link"}>
                      ...
                      <li className="nav__item">
                          <a href="#skills" onClick={() => setActiveNav("#skills")} className=
                            {activeNav === "#skills" ? "nav__link active__link" : "nav__link"}>
                              <i className="uil uil-file-alt nav__icon"></i> Conhecimentos
                          </a>
                      </li>
  
                      <li className="nav__item">
                          <a href="#servicos" onClick={() => setActiveNav("#servicos")} className=
                            {activeNav === "#servicos" ? "nav__link active__link" : "nav__link"}>
                              <i className="uil uil-briefcase nav__icon"></i> Serviços
                          </a>
                      </li>
  
                      <li className="nav__item">
                          <a href="#projetos" onClick={() => setActiveNav("#projetos")} className=
                            {activeNav === "#projetos" ? "nav__link active__link" : "nav__link"}>
