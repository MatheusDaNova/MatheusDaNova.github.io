                ...
                <div className="contact__content">
                    ...
                    <form className="contact__form">
                        ...
                        <div className="contact__form-div">
                            ...
                            <textarea name="projeto" cols="30" rows="10" className="contact__form-input" placeholder="Mande seu projeto aqui"></textarea>
                        </div>

                        <button className="button button--flex"> Encaminhar e-mail
